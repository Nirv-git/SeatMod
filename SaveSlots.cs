...
namespace SeatMod
{
    class SaveSlots
    {
        ...
        {//type T|F - Pos|Rot
            ...
            catch (System.Exception ex) { Main.Logger.Error($"Error storing new saved {(type ? "position" : "rotation")}\n" + ex.ToString()); }
        }
        ...
        public static Dictionary<int, string> GetSavedSlotNames(bool type)
        {
            ...
            catch (System.Exception ex) { Main.Logger.Error($"Error loading slot names - {(type ? "position" : "rotation")}- Resetting to Defaults:\n" + ex.ToString()); melonPref.Value = "1,N/A;2,N/A;3,N/A;4,N/A;5,N/A;6,N/A"; }
        ...
        public static void StoreSlotNames(int location, string updated, bool type)
        {
            ...
            catch (System.Exception ex) { Main.Logger.Error($"Error storing new saved slot names - {(type ? "position" : "rotation")}\n" + ex.ToString()); }
        }
